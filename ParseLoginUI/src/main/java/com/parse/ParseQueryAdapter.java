...
public class ParseQueryAdapter<T extends ParseObject> extends BaseAdapter {
     ...
     *
     * @param context The activity utilizing this adapter.
     * @param clazz   The {@link ParseObject} subclass type to fetch and display.
     */
     ...
     *
     * @param context   The activity utilizing this adapter.
     * @param className The name of the Parse class of {@link ParseObject}s to display.
     */
     ...
     * @param context          The activity utilizing this adapter.
     * @param clazz            The {@link ParseObject} subclass type to fetch and display.
     * @param itemViewResource A resource id that represents the layout for an item in the AdapterView.
     */
    public ParseQueryAdapter(Context context, Class<? extends ParseObject> clazz,
     ...
     *
     * @param context      The activity utilizing this adapter.
     * @param queryFactory A {@link QueryFactory} to build a {@link ParseQuery} for fetching objects.
     */
     ...
     * @param v      The {@code View} associated with this row. This view, if non-null, is being recycled
     ...
     *
     * @param v      The view object associated with this row + type (a "Next Page" view, instead of an
     *               "Item" view).
     * @param parent The parent that this view will eventually be attached to
     ...
     * @param query the {@link ParseQuery} used to fetch items from Parse. This query will be mutated and
     ...
     *
     * @param paginationEnabled Defaults to true.
     */
     ...
     * display.
     *
     * @param placeholder A {@code Drawable} to be displayed while the remote image data is being fetched. This
     ...
     * Defaults to true.
     *
     * @param autoload Defaults to true.
     */
