...
public class ParseImageView extends ImageView {
     ...
     *
     * @param context      Context for this View
     * @param attributeSet AttributeSet defined for this View in XML
     */
     ...
     * @param context      Context for this View
     * @param attributeSet AttributeSet defined for this View in XML
     * @param defStyle     Class-specific base style.
     */
     ...
     *
     * @param file The remote file on Parse's server.
     */
     ...
     *
     * @param completionCallback A custom {@code GetDataCallback} to be called after the image data is fetched and this
